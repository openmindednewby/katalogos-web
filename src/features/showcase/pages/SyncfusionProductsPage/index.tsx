...
export const SyncfusionProductsPage = (): ReactElement => {
    ...
    <div style={{ padding: FALLBACK_PADDING }}>
      ...
      {isReady ? <>
          ...
          <div data-testid="products-grid">
            <table className="e-grid" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  <th>Title</th>
                  <th>Category</th>
              ...
              <tbody>
                {filtered.map((product) => (
                  <tr key={product.id} className="e-row">
                    <td>{product.title}</td>
...
export default SyncfusionProductsPage;
