/**
 * PageSkeleton - Skeleton loader for full pages.
 *
 * Shows a shimmer effect while page content is loading.
 * Improves perceived performance (Speed Index) by showing immediate visual feedback.
 */
...
const PageSkeleton: React.FC<Props> = ({ rows = 5, showHeader = true, variant = 'list' }) => {
  ...
  return (
    <View
      accessibilityHint={FM('pageSkeleton.loadingHint')}
      accessibilityLabel={FM('pageSkeleton.loadingLabel')}
      accessibilityState={{ busy: true }}
      style={[styles.container, { backgroundColor: colors.background }]}
      testID={TestIds.PAGE_SKELETON}
    >
