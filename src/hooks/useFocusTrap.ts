 ...
 *
 * On enable: saves the previously focused element and focuses the first
 * focusable child. Tab wraps from last to first; Shift+Tab wraps from
 * first to last. On disable/unmount: restores focus to the saved element.
 */
