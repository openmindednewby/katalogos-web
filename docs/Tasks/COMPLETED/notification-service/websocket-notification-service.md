...
> **Priority**: High
> **Complexity**: High
> **Estimated Effort**: 6-8 weeks (including User Notification Control & Web Push)
...
2. [Additional Requirements: User Notification Control & Desktop Push](#additional-requirements-user-notification-control--desktop-push)
3. [Problem Statement](#problem-statement)
4. [Architecture Overview](#architecture-overview)
5. [Technology Stack](#technology-stack)
6. [System Design](#system-design)
7. [Scalability Patterns - Decision Required](#scalability-patterns---decision-required)
8. [Backplane Options Comparison](#backplane-options-comparison)
9. [ASP.NET Core 8+ Features](#aspnet-core-8-features)
...
15. [Implementation Phases](#implementation-phases)
    ...
    - **Phase 6: Global Notification Toggle** (NEW)
    - **Phase 7: Service Worker for OS Notifications** (NEW - SignalR only, no external push services)
...
|----------|--------|-----------|
| WebSocket Technology | SignalR | Native .NET support, automatic reconnection, fallback protocols |
| Message Broker | Redis Pub/Sub (initial), RabbitMQ (scale) | Simple start, proven scalability path |
| Backplane | Redis (SignalR Backplane) | Required for horizontal scaling |
| Persistence | PostgreSQL + Redis | Offline queuing + connection state |
| Protocol | WebSocket with SSE fallback | SignalR handles this automatically |
| **Global Notification Toggle** | User-level disable with storage | Audit trail preserved, delivery skipped |
| **Desktop Notifications** | Web Push API + Service Workers | Real OS-level notifications when tab unfocused |
...
## 🔷 Option A: Skip Negotiation + Redis Backplane (Recommended)
